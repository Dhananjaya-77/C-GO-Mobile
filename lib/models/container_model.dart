...
class ContainerInfo {
  ...
  static ContainerInfo mockPrimaryContainer = ContainerInfo(
    ...
    originPort: 'Colombo Fort',
    destinationDepot: 'Orugodawaththa',
    designatedCorridor: 'Colombo Fort to Orugodawaththa',
  ...
  static List<ContainerInfo> mockContainerFleet = [
    ...
    ContainerInfo(
      ...
      originPort: 'Colombo Fort',
      destinationDepot: 'Grayline 1',
      designatedCorridor: 'Colombo Fort to Grayline 1',
      telemetry: SensorTelemetry(
        isMagneticReedClosed: true,
        lightSensorLux: 0.0,
        batteryLevel: 88,
    ...
    ContainerInfo(
      ...
      originPort: 'Colombo Fort',
      destinationDepot: 'Grayline 2',
      designatedCorridor: 'Colombo Fort to Grayline 2',
      telemetry: SensorTelemetry(
